// ============================================
// AVATAR SETTINGS - ANIMALS CATEGORY
// Adaptado del código de Eiwa para usar imágenes SVG
// ============================================
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let currentStyle = window.AVATAR_CONFIG?.style || 'dog-breed-1';
    let currentBgColor = window.AVATAR_CONFIG?.bgColor || '#A8E6CF';
    ...
    function updatePreview() {
        ...
        const svgPath = selectedInput.dataset.svg;
        ...
        avatarPreview.innerHTML = `<img src="${svgPath}" alt="Avatar Preview" style="width: 100%; height: 100%; object-fit: contain;">`;
    }
